...
public class Capture {
    ...
    private Properties setLogs() {
        ...
        for (int i = 0; i < infos.length; i++) {
            ...
            properties.put(appender + ".layout.ConversionPattern", "%d{dd/MM/yyyy" + this.params.getSeparateur() + "HH:mm:ss}"
                    + this.params.getSeparateur() + "%m%n");
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    // Get the parameters from the XML file jbossreportserver.xml, otherwise
    // jbossreportdefault.xml
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////
