            ...
            for (i = 0; i < this.infos.length; i++) {
                if (this.mbeans[i] != null) {
                    ...
                    for (int j = 0; j < getAttributs(i).length; j++) {
                        ...
                        //System.out.println("mbean="+this.infos[i].getProperty("name")+"*");
                        //System.out.println("mbean="+this.mbeans[i]+"attribut="+getAttributs(i)[j]);
                        Object result = this.adaptor.getAttribute(this.mbeans[i], getAttributs(i)[j]);
                        ...
                        if (result instanceof Stats) {
                            ...
                            for (int k = 0; k < wantedStatsNames.length; k++) {
                                ...
                                if (stat != null) {
                                    ...
                                    //System.out.println(stats[k].getName()+"="+stats[k].getUnit());
                                } else
                                    datas.append("0");//Stat pas encore
                                                      // d�marr�e
                            }
                        } else {
                            datas.append(result);
                            //System.out.println(getAttributs(i)[j]+"="+result);
                        }
                    }
